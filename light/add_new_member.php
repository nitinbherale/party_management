                    ...
                    <div class="body">
                        <form>
                            ...
                            <div class="form-group">                                
                                <input type="text" id="email_address" class="form-control" placeholder="Enter your name" name="fname">
                            </div>
                            <label for="designation">Designation</label>
                            <div class="form-group">                                
                                <input type="text" id="email_address" class="form-control" placeholder="Enter your name" name="designation">
                            </div>
                            ...
                            <div class="form-group">                                
                                <input type="text" id="email_address" class="form-control" placeholder="Enter your Mobile No." name="mobile">
                            </div>
                             <label for="whatsapp_no">Whatsapp No.</label>
                            <div class="form-group">                                
                                <input type="text" id="email_address" class="form-control" placeholder="Enter your Whatsapp No." name="whatsapp_no">
                            </div>
                             <label for="district">District*</label>
                            <div class="form-group">                                
                                <input type="text" id="email_address" class="form-control" placeholder="Enter your District" name="district">
                            </div>
                            <label for="tahsil">Tahsil*</label>
                            <div class="form-group">                                
                                <input type="text" id="email_address" class="form-control" placeholder="Enter your Tahsil" name="tahsil">
                            </div>
                              <label for="street">Street*</label>
                            <div class="form-group">                                
                                <input type="text" id="email_address" class="form-control" placeholder="Enter your Street" name="street">
                            </div>
                             <label for="city">City*</label>
                            <div class="form-group">                                
                                <input type="text" id="email_address" class="form-control" placeholder="Enter your City" name="city">
                            </div>
                            <label for="postal_code">Postal Code*</label>
                            <div class="form-group">                                
                                <input type="text" id="email_address" class="form-control" placeholder="Enter your Postal Code" name="p_code">
                            </div>
                            ...
                            <div class="input-group">
                                    ...
                                    <input type="date" class="form-control datetimepicker" placeholder="Please choose date &amp; time..." data-dtp="dtp_322XI">
                                </div>
                           ...
                           <div class="form-check form-check-inline">
                            ...
                            <button type="button" class="btn btn-raised btn-primary btn-round waves-effect">CREATE MEMBER</button>
                        </form>
                    </div>
                </div>
            </div>
